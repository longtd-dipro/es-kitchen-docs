...
| `backend-agent.md`  | NestJS Developer  | Read, Edit, Write, Bash, tilth_*     | Implement/review API, service, entity, migration    |
| `frontend-agent.md` | React Developer   | Read, Edit, Write, tilth_*           | Implement/review component, hook, store (E02 + E03) |
...
> **Tech Lead** (Design + Tasks) không có agent riêng — thực hiện qua `/create-design` và `/create-tasks`.                                                                                                                             
...
| `technical.md`        | Tech stack detail, git convention, CI/CD, known bugs        | `/create-design`, `backend-agent`                                             |
| `backlog-workflow.md` | Issue types, status workflow, title format, phân quyền      | Tất cả agents khi tạo/reference task                                          |
| `doc-structure.md`    | Cấu trúc SPEC/DESIGN/task — single-epic vs cross-repo path  | `ba-agent`, `/create-spec`, `/create-design`, `/create-tasks`, `/create-plan` |
...
| 3     | Frontend E02/E03 + Mobile E01 (song song) | web + payment-app |
